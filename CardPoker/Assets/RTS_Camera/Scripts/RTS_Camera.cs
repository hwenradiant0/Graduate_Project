...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            SetTarget(GameObject.FindWithTag("NowTarget").transform);
        }
        ...
        {
            Vector3 targetPos = new Vector3(targetFollow.position.x, targetFollow.position.y, targetFollow.position.z) + targetOffset;
