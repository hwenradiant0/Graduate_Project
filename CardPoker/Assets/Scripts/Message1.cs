	...
	void Update ()
    {
        ...
        switch(numScript)
        {
            ...
            case 3:
                ...
                GameObject.Find("Tutorial").transform.FindChild("Message1").gameObject.SetActive(false);
                GameObject.Find("Tutorial").transform.FindChild("Message2").gameObject.SetActive(true);
                break;
            default:
                break;
        }
